---
_Als Unternehmer, engagierte Bürger, Wissenschaftler, eingetragene Firmen, Agenturen und Entwickler sprachen wir in der vergangenen Zeit mit sehr verschiedenen Begriffen über die gleiche Sache: MyData, Self Data, VRM (Vendor Relationship Management), Internet of Me, PIMS (Personal Information Management Services) usw. mit dem gemeinsamen Ziel: **Jeden Einzelnen mit seinen personenbezogenen Daten zu ermächtigen, für sich und seine Netzwerk, Wissen zu schaffen, Entscheidungen informierter zu treffen und bewusster und effizienter miteinander und in Organisationen zusammen zu wirken**_
