---
_Wir sind Unternehmer, Engagierte, Akademiker, registrierte Firmen, Agenturen und Entwickler. Über all die Jahre haben wir unterschiedliche Begriffe verwendet für unser Tun: MyData, Self Data, VRM (Vendor Relationship Management), Internet of Me, PIMS (Personal Information Management Services) usw., und für unser gemeinsames Ziel: **Individuen ermächtigen mit ihren personenbezogenen Daten, und somit für sie selbst und in ihren Verbindungen, Wissen zu schaffen, informierte Entscheidungen zu treffen und bewusster und effizienter miteinander und mit Organisationen zusammen zu wirken**_
