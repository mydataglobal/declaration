---
_Wir sind Unternehmer, engagierte Bürger, Wissenschaftler, eingetragene Firmen, Agenturen und Entwickler. In der vergangenen Zeit haben wir sehr verschiedene Begriffen für unsere Sache genommen: MyData, Self Data, VRM (Vendor Relationship Management), Internet of Me, PIMS (Personal Information Management Services) usw., und sind für unser gemeinsames Ziel eingetreten: **Einzelne mit ihren personenbezogenen Daten zu ermächtigen, und somit für sich selbst und ihre Kontakte Wissen zu schaffen, informierte Entscheidungen zu treffen und bewusster und effizienter miteinander und mit Organisationen zusammen zu wirken**_
