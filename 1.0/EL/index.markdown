...
_Είμαστε επιχειρηματίες, ακτιβιστές, ακαδημαϊκοί, εισηγμένες εταιρίες, δημόσιοι οργανισμοί και προγραμματιστές. Για χρόνια, χρησιμοποιούμε διαφορετικές λέξεις για να περιγράψουμε αυτό που κάνουμε - MyData, Self Data, VRM (Vendor Relationship Management), Internet Me, PIMS (Personal Information Management Services) κλπ, ενώ μοιραζόμασταν έναν κοινό στόχο: **το να ενδυναμώσουμε το άτομο σε σχέση με τα προσωπικά του δεδομένα, βοηθώντας τόσο αυτόν όσο και τις κοινότητές στις οποίες ανήκει να αναπτύξουν γνώση, να λάβουν τεκμηριωμένες αποφάσεις και να αλληλεπιδρούν πιο συνειδητά και αποτελεσματικά μεταξύ τους καθώς και με οργανισμούς.**_

_Τα τελευταία χρόνια δημιουργήσαμε μαζί ένα δίκτυο των οποίων οι συμμετέχοντες μοιράζονται την εμπειρία, αναπτύσσουν κοινά έργα, συναντώνται στα συνέδρια MyData και συμμετέχουν σε συλλογικές προσπάθειες για μια ανθρωποκεντρική προσέγγιση στα προσωπικά δεδομένα._
