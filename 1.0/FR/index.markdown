---
_Nous sommes des entrepreneurs, des militants, des universitaires, des sociétés cotées en bourse, des organismes publics et des promoteurs. Depuis des années, nous utilisons des mots différents pour ce que nous faisons - MyData, Self Data, VRM (Vendor Relationship Management), Internet of Me, PIMS (Personal Information Management Services) etc, **tout en partageant un objectif commun : donner aux individus les moyens d'utiliser leurs données personnelles, les aidant ainsi, ainsi que leurs communautés, à développer leurs connaissances, à prendre des décisions éclairées et à interagir plus consciemment et plus efficacement entre eux ainsi qu'avec les organisations**_
